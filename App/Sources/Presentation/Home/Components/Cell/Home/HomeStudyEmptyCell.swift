//
//  HomeStudyEmptyCell.swift
//  App
//
//  Created by Kim dohyun on 2022/11/06.
//
...
final class HomeStudyEmptyCell: UICollectionViewCell {
    ...
    private func configure() {
        ...
        self.contentView.addSubview(emptyContainerView)
        ...
        emptyInfoLabel.snp.makeConstraints {
            ...
            $0.centerY.equalTo(emptyImageView)
        }
